...
INSERT INTO lfoz4j8nwop9wi8l.archetypes(archetype, archetype_description,createdAt,updatedAt) 
...
INSERT INTO lfoz4j8nwop9wi8l.answers(answer,points,createdAt,updatedAt,questionId,personalityId) VALUES("Pidgey",1,now(),now(),1,3);
INSERT INTO lfoz4j8nwop9wi8l.answers(answer,points,createdAt,updatedAt,questionId,personalityId) VALUES("Spearow",1,now(),now(),1,1);
INSERT INTO lfoz4j8nwop9wi8l.answers(answer,points,createdAt,updatedAt,questionId,personalityId) VALUES( "Caterpie",1,now(),now(),1,2);
INSERT INTO lfoz4j8nwop9wi8l.answers(answer,points,createdAt,updatedAt,questionId,personalityId) VALUES("Weedle",1,now(),now(),1,4);

-- Answers Seed - Question 2
INSERT INTO lfoz4j8nwop9wi8l.answers(answer,points,createdAt,updatedAt,questionId,personalityId) VALUES("Ash",1,now(),now(),2,1);
INSERT INTO lfoz4j8nwop9wi8l.answers(answer,points,createdAt,updatedAt,questionId,personalityId) VALUES("Misty",1,now(),now(),2,4);
INSERT INTO lfoz4j8nwop9wi8l.answers(answer,points,createdAt,updatedAt,questionId,personalityId) VALUES( "Brock",1,now(),now(),2,2);
INSERT INTO lfoz4j8nwop9wi8l.answers(answer,points,createdAt,updatedAt,questionId,personalityId) VALUES("Gary",1,now(),now(),2,3);

-- Answers Seed - Question 3
INSERT INTO lfoz4j8nwop9wi8l.answers(answer,points,createdAt,updatedAt,questionId,personalityId) VALUES("Psychic",1,now(),now(),3,2);
INSERT INTO lfoz4j8nwop9wi8l.answers(answer,points,createdAt,updatedAt,questionId,personalityId) VALUES("Ghost",1,now(),now(),3,3);
INSERT INTO lfoz4j8nwop9wi8l.answers(answer,points,createdAt,updatedAt,questionId,personalityId) VALUES( "Dark",1,now(),now(),3,4);
INSERT INTO lfoz4j8nwop9wi8l.answers(answer,points,createdAt,updatedAt,questionId,personalityId) VALUES("Dragon",1,now(),now(),3,1);

-- Answers Seed - Question 4
INSERT INTO lfoz4j8nwop9wi8l.answers(answer,points,createdAt,updatedAt,questionId,personalityId) VALUES("Pewter",1,now(),now(),4,1);
INSERT INTO lfoz4j8nwop9wi8l.answers(answer,points,createdAt,updatedAt,questionId,personalityId) VALUES("Cerulean",1,now(),now(),4,4);
INSERT INTO lfoz4j8nwop9wi8l.answers(answer,points,createdAt,updatedAt,questionId,personalityId) VALUES( "Cinnabar",1,now(),now(),4,3);
INSERT INTO lfoz4j8nwop9wi8l.answers(answer,points,createdAt,updatedAt,questionId,personalityId) VALUES("Viridian",1,now(),now(),4,2);

-- Answers Seed - Question 5
INSERT INTO lfoz4j8nwop9wi8l.answers(answer,points,createdAt,updatedAt,questionId,personalityId) VALUES("I played it, it was a lot of fun!",1,now(),now(),5,1);
INSERT INTO lfoz4j8nwop9wi8l.answers(answer,points,createdAt,updatedAt,questionId,personalityId) VALUES("Oh, there's a new game out already?",1,now(),now(),5,2);
INSERT INTO lfoz4j8nwop9wi8l.answers(answer,points,createdAt,updatedAt,questionId,personalityId) VALUES("It was funny watching people fight about it on twitter :)",1,now(),now(),5,3);
INSERT INTO lfoz4j8nwop9wi8l.answers(answer,points,createdAt,updatedAt,questionId,personalityId) VALUES("DEXIT DEXIT DEXIT",1,now(),now(),5,4);

-- Answers Seed - Question 6
INSERT INTO lfoz4j8nwop9wi8l.answers(answer,points,createdAt,updatedAt,questionId,personalityId) VALUES("I like the newer ones better.",1,now(),now(),6,1);
INSERT INTO lfoz4j8nwop9wi8l.answers(answer,points,createdAt,updatedAt,questionId,personalityId) VALUES("Those are the only ones I have played!",1,now(),now(),6,2);
INSERT INTO lfoz4j8nwop9wi8l.answers(answer,points,createdAt,updatedAt,questionId,personalityId) VALUES("Lol missingno lol",1,now(),now(),6,3);
INSERT INTO lfoz4j8nwop9wi8l.answers(answer,points,createdAt,updatedAt,questionId,personalityId) VALUES("Everything that came later was a pale imitation. Final.",1,now(),now(),6,4);

-- Answers Seed - Question 7
INSERT INTO lfoz4j8nwop9wi8l.answers(answer,points,createdAt,updatedAt,questionId,personalityId) VALUES("Pikachu is cute and friendly! What's NOT to like?",1,now(),now(),7,2);
INSERT INTO lfoz4j8nwop9wi8l.answers(answer,points,createdAt,updatedAt,questionId,personalityId) VALUES("Uh, it's a little overexposed...",1,now(),now(),7,1);
INSERT INTO lfoz4j8nwop9wi8l.answers(answer,points,createdAt,updatedAt,questionId,personalityId) VALUES("Please. Show me another pokemon. ANY other pokemon.",1,now(),now(),7,4);
INSERT INTO lfoz4j8nwop9wi8l.answers(answer,points,createdAt,updatedAt,questionId,personalityId) VALUES("Mimikyu for the win!",1,now(),now(),7,3);

-- Answers Seed - Question 8
INSERT INTO lfoz4j8nwop9wi8l.answers(answer,points,createdAt,updatedAt,questionId,personalityId) VALUES("Charizard is tough! It's great!",1,now(),now(),8,2);
INSERT INTO lfoz4j8nwop9wi8l.answers(answer,points,createdAt,updatedAt,questionId,personalityId) VALUES("Uh, it's a little overexposed...",1,now(),now(),8,1);
INSERT INTO lfoz4j8nwop9wi8l.answers(answer,points,createdAt,updatedAt,questionId,personalityId) VALUES("But what about bulbasaur?",1,now(),now(),8,3);
INSERT INTO lfoz4j8nwop9wi8l.answers(answer,points,createdAt,updatedAt,questionId,personalityId) VALUES("Why isn't it dragon-type?",1,now(),now(),8,4);

-- Answers Seed - Question 9
INSERT INTO lfoz4j8nwop9wi8l.answers(answer,points,createdAt,updatedAt,questionId,personalityId) VALUES("The games are the crux of the franchise!",1,now(),now(),9,4);
INSERT INTO lfoz4j8nwop9wi8l.answers(answer,points,createdAt,updatedAt,questionId,personalityId) VALUES("I watched the anime as a child or with my current children, it's pretty fun.",1,now(),now(),9,2);
INSERT INTO lfoz4j8nwop9wi8l.answers(answer,points,createdAt,updatedAt,questionId,personalityId) VALUES("Manga has the best plot and worldbuilding, even if it's a little niche.",1,now(),now(),9,3);
INSERT INTO lfoz4j8nwop9wi8l.answers(answer,points,createdAt,updatedAt,questionId,personalityId) VALUES("I'm just happy there's so much pokemon content out there!",1,now(),now(),9,1);

-- Answers Seed - Question 10
INSERT INTO lfoz4j8nwop9wi8l.answers(answer,points,createdAt,updatedAt,questionId,personalityId) VALUES("I'm going to keep it and show it off!",1,now(),now(),10,2);
INSERT INTO lfoz4j8nwop9wi8l.answers(answer,points,createdAt,updatedAt,questionId,personalityId) VALUES("I'm going to trade it for a PVP optimized pokemon!",1,now(),now(),10,4);
INSERT INTO lfoz4j8nwop9wi8l.answers(answer,points,createdAt,updatedAt,questionId,personalityId) VALUES("Why does anyone care about shinies anyway?",1,now(),now(),10,1);
INSERT INTO lfoz4j8nwop9wi8l.answers(answer,points,createdAt,updatedAt,questionId,personalityId) VALUES("What is a shiny?",1,now(),now(),10,3);

-- Answers Seed - Question 11
INSERT INTO lfoz4j8nwop9wi8l.answers(answer,points,createdAt,updatedAt,questionId,personalityId) VALUES("Time to complete the pokedex!",1,now(),now(),11,2);
INSERT INTO lfoz4j8nwop9wi8l.answers(answer,points,createdAt,updatedAt,questionId,personalityId) VALUES("What's the post-game story like?",1,now(),now(),11,3);
INSERT INTO lfoz4j8nwop9wi8l.answers(answer,points,createdAt,updatedAt,questionId,personalityId) VALUES("Competitive battles, here I come!",1,now(),now(),11,4);
INSERT INTO lfoz4j8nwop9wi8l.answers(answer,points,createdAt,updatedAt,questionId,personalityId) VALUES("I'm going to play a different game, now that I've beaten this one.",1,now(),now(),11,1);